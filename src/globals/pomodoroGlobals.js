...
// const INACTIVITY_ALARM_TIMEOUT = ms('1s')
let INACTIVITY_ALARM_COUNTER = {
    value: 0
};
...
module.exports = { POMODORO_TIMING_DETAILS, POMODORO_PERIODS, POMODORO_STATUS, POMODORO_SKIP_CODES, pomodoroActivityDetails, CLIENT, ALLOWED_CHANNELS, INTENTS, INACTIVITY_ALARM_TIMEOUT, POMODORO_RESET_CODES, INACTIVITY_ALARM_COUNTER }
